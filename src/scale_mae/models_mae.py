...
from src.scale_mae.lib.fpn import FCNHead, FPNHead
from src.scale_mae.lib.gpt import Block as GPTBlock
from src.scale_mae.lib.transformer import MAEDecoder
from timm.models.vision_transformer import Block, PatchEmbed
from src.scale_mae.util.pos_embed import (
...
class MaskedAutoencoderViT(nn.Module):
    ...
    def forward_features(self, x, input_res):
        x, _, _, _ = self.forward_encoder(x, mask_ratio=0.0, input_res=input_res)
        return x
